...
A micro game engine delivering real-time games for the terminal.
...
After cloning the full repository, navigate to the [`Demos`](Demos) directory. The demo project can be run without installation via the .NET CLI:
...
To solve this, Termule splits runtime behavior into two major types: `System`s and `Component`s.
