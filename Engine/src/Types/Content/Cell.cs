...
/// <param name="charCalor">The color of the cell's character (or the default if none is provided).</param>
#pragma warning disable SA1313
public struct Cell(Color color = default, char character = default, Color charCalor = default)
{
    /// <summary>
    ...
    /// </summary>
    public Color CharColor { get; set; } = charCalor;
    ...
    {
        return HashCode.Combine(this.Color, this.Char, this.CharColor);
    }
}
